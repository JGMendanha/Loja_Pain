...
Postagem de comentários sobre os produtos
Exclusão de produtos
Exclusão de comentários
Cadastro de usuário
Interação entre membros e organização nos comentários
...
Tela de histórico de compra: Tela responsável por exibir o histórico de compras, sendo ele dividido entre compras não entregues e compras entregues.
Tela de exibição de produto específico: Tela responsável por exibir detalhes e comentários de um produto específico.
Tela de administrador: Tela em que o admin da página pode cadastrar/apagar produtos, fazer o controle de estoque dos produtos, verificar comentários dos usuários. 
